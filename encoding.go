...
func (ec *extendedContract) DecodeFrom(d *types.Decoder) {
	...
	(*types.V1Currency)(&ec.contractPrice).DecodeFrom(d)
	(*types.V1Currency)(&ec.totalCost).DecodeFrom(d)
	(*types.V1Currency)(&ec.uploadSpending).DecodeFrom(d)
	(*types.V1Currency)(&ec.downloadSpending).DecodeFrom(d)
	(*types.V1Currency)(&ec.fundAccountSpending).DecodeFrom(d)
...
func (sr *shareRequest) EncodeToWithoutSignature(e *types.Encoder) {
	...
	for _, contract := range sr.Contracts {
		...
		types.V1Currency(contract.Spending.Uploads).EncodeTo(e)
		types.V1Currency(contract.Spending.Downloads).EncodeTo(e)
		types.V1Currency(contract.Spending.FundAccount).EncodeTo(e)
		types.V1Currency(contract.ContractPrice).EncodeTo(e)
		types.V1Currency(contract.TotalCost).EncodeTo(e)
